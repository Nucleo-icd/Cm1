...
document.getElementById('login-form').addEventListener('submit', async function (e) {
  ...
  if (username === 'ambulatorio' && password === 'ambulatorio') {
    try {
      ...
      const powerBIUrl = "https://app.powerbi.com/view?r=eyJrIjoiNTA1NjRlYmItYjgxMS00NzZhLTk4OWUtMTJhYmJmNTU1MTJiIiwidCI6IjNhNzhiMGNkLTdjOGUtNDkyOS08M2Q1LTE5MGE2Y2MwMTM2NSJ9";
